...
%%  GUI_SETVELOCITYPARAMETERS Write the velocity profile to the actuators interface.
%   Function to modify the velocity profile of the motors. All the consistency checks
%   are done here before calling the HW_setVelocityProfile.
%   Refer to Thorlabs manuals for details on the actuator's velocity
%   profile.
