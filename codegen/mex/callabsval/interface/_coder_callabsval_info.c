...
/* Include files */
#include "_coder_callabsval_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("callabsval"));
...
/* End of code generation (_coder_callabsval_info.c) */
