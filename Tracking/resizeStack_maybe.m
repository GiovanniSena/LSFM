function mat_rs = resizeStack_maybe(varargin)
 %% RESIZE     Resize a matrix.
 % function [ resizedImg ] = resizeStack( originalImg, scale_xy, scale_z )
...
if nargin == 3
    mat_rs = resizeStack_maybe(varargin{1}, [varargin{2}, varargin{3}]);
else
    mat_rs = resizeStack_maybe(varargin{1}, [varargin{2}, varargin{3}], varargin{4});
end
return
